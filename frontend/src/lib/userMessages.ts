...
const MESSAGES: Record<string, string> = {
  ...
  'Username must be lowercase letters and numbers only':
    'Nome de usuário deve ter apenas letras minúsculas e números.',
  'Username must be 2–32 chars, lowercase letters and numbers only':
    'Nome de usuário deve ter 2 a 32 caracteres, apenas letras minúsculas e números.',
  'Invalid uuid': 'ID inválido. Verifique o ID do oponente.',
  'opponentUserId required. Use the matchmaking queue to find a match, or provide opponentUserId to challenge a friend.':
    'Informe o oponente para desafiar ou use a fila para encontrar partida.',
