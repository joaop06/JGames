      ...
      <div className="tic-tac-toe-lobby__cards">
        <Card glow style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'var(--space-3)' }}>
            <Button className="lobby-btn" onClick={handleSearchMatch} disabled={searching}>
        ...
        <Link to="/friends" className="tic-tac-toe-lobby__friend-card">
          ...
          >
            <h2
              style={{ fontFamily: 'var(--font-display)', fontSize: 'var(--size-lg)', margin: 0 }}
            >
              Desafie um amigo
            </h2>
            <p
              style={{ color: 'var(--text-muted)', fontSize: 'var(--size-sm)', margin: 0, flex: 1 }}
            >
